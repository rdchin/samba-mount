...
if [ -r /$THIS_DIR/mountup.lib ] && [ -r/$THIS_DIR/mountup_servers.lib ] ; then
   ...
   f_msg_txt_file_nok $GUI "NOK" "Error File Missing" "Required module file \"mountup.lib\" is missing.\nCannot continue, exiting program script." 3
   exit 1
fi
#
